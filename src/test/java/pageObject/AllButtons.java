...
public class AllButtons {
    public AllButtons(WebDriver driver) {
    ...
    @AndroidFindBy(id = "com.nra.productmarketingmaker:id/templateView")
    public WebElement Preview;

    @AndroidFindBy(id = "com.nra.productmarketingmaker:id/btnClose")
